...
struct Node * find_ll(struct Node * anchor, char * word) {
        ...
        // the list for the word. return the pointer to the with the word, if f\
ound,
...
void remove_ll( struct Node * anchor, struct Node * node_to_remove ) {
        // given a list anchor, and a pointer to a node in the list (but not th\
e anchor)
